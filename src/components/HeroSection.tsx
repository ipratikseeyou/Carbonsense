      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20">
            <div className="text-3xl font-bold text-primary-glow mb-2">47,382</div>
            <div className="text-white/80">Tons CO₂ Verified</div>
          </div>
          
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20">
            <div className="text-3xl font-bold text-earth-green-light mb-2">156</div>
            <div className="text-white/80">Active Projects</div>
          </div>
          
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20">
            <div className="text-3xl font-bold text-satellite-glow mb-2">99.7%</div>
