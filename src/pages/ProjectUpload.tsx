...
import { Upload, MapPin, Building, FileText } from 'lucide-react';
...
const projectFormSchema = z.object({
  ...
  project_area: z.number().min(0.1).optional(),
  forest_type: z.string().optional(),
  monitoring_period_start: z.string().optional(),
  monitoring_period_end: z.string().optional(),
  last_verification_date: z.string().optional(),
  baseline_methodology: z.string().optional(),
  verification_standard: z.string().optional(),
  uncertainty_percentage: z.number().min(0).max(100).optional(),
  developer_name: z.string().optional(),
  developer_contact: z.string().email().optional().or(z.literal('')),
  land_tenure: z.string().optional(),
