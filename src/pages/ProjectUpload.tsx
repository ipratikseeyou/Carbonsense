        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="glass-card backdrop-blur-xl border-primary/20 hover:border-primary/30 transition-all duration-400 animate-soft-scale">
            <CardHeader className="text-center">
              <CardTitle className="flex items-center justify-center gap-3 font-premium-serif text-2xl text-black">
                <div className="p-2 rounded-full bg-gradient-copper animate-gentle-bounce">
                  <MapPin className="h-5 w-5 text-white" />
                </div>
                Project Details
              </CardTitle>
              <CardDescription className="font-premium-sans text-black">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  field
                        ...
                        <FormLabel className="text-black font-premium-sans font-medium">Project Name</FormLabel>
                        <FormControl>
                          <Input placeholder="Amazon Rainforest Restoration" {...field} className="glass-panel border-primary/20 text-black placeholder:text-gray-500 focus:border-primary/50 transition-all duration-300 hover:scale-[1.01] bg-white/95" />
                        </FormControl>
                  ...
                  field
                        ...
                        <FormLabel className="text-black font-premium-sans font-medium">Project Location</FormLabel>
                        <FormControl>
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 text-sm glass-panel rounded-lg px-3 py-2 border-primary/10 bg-white/95">
                              ...
                              <span className="font-premium-mono text-black font-medium">Current coordinates: {form.watch('coordinates')}</span>
                            </div>
                          </div>
                        </FormControl>
                        <FormMessage className="text-red-600" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    field
                          ...
                          <FormLabel className="text-black font-premium-sans font-medium">Carbon Tons</FormLabel>
                          <FormControl>
                            <Input type="number" step="0.1" placeholder="1000" {...field} onChange={e => field.onChange(parseFloat(e.target.value) || 0)} className="glass-panel border-primary/20 text-black placeholder:text-gray-500 focus:border-earth-green-light/50 transition-all duration-300 hover:scale-[1.01] bg-white/95" />
                          </FormControl>
                          <FormMessage className="text-red-600" />
                        </FormItem>} />
                  ...
                  field
                        ...
                        <FormLabel className="text-black font-premium-sans font-medium">Satellite Image URL (Optional)</FormLabel>
                        <FormControl>
                  ...
                  <div className="flex gap-4 pt-4">
                    <Button type="button" variant="glass" onClick={() => navigate('/projects')} className="flex-1 hover:border-white/30 animate-gentle-bounce text-black">
                      Cancel
                    </Button>
